...
const classes = [
  {
    ...
    description: "Lorem ipsum dolor sit amet consectetur adipisicing elit. At a repudiandae molestias. Explicabo eligendi dolores impedit quo rerum non inventore."
  },
  {
    name: "cardio",
