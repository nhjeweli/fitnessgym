  ...
  return (
    <Swiper className="h-full">
      <SwiperSlide className="h-full flex justify-end pt-48">
        <div className="h-full flex justify-end pt-8">
          <div className="flex flex-col items-center lg:items-start lg:max-w-[700px]">
            ...
            <motion.p variants={fadeIn("up", 0.6)} initial="hidden" whileInView={"show"} viewport={{ once: false, amount: 0.2 }} className="text-white italic text-center lg:text-left mb-4">
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Adipisci repudiandae atque facere numquam quos cum quibusdam sed officiis quidem laborum.
            </motion.p>
      ...
      <SwiperNavButtons containerStyles="absolute bottom-2 lg:bottom-0 right-0 h-[130px] w-full lg:w-[700px] z-50 flex justify-center lg:justify-start gap-1" btnStyles="border border-accent text-white w-[56px] h-[56px] flex justify-center items-center hover:bg-accent transition-all duration-300" iconStyles="text-2xl" />
    </Swiper>
  )
}
